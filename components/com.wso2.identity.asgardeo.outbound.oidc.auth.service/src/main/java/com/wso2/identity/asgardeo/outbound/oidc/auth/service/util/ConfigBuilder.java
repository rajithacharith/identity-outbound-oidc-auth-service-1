...
package com.wso2.identity.asgardeo.outbound.oidc.auth.service.util;
...
import static com.wso2.identity.asgardeo.outbound.oidc.auth.service.util.Constants.ErrorMessages.ERROR_READING_CONFIGURATION_FILES;
...
public class ConfigBuilder {
    ...
    public ServerConfig build() throws OutboundOIDCServiceException {
        ...
        try {
            ...
            throw new OutboundOIDCServiceException(ERROR_READING_CONFIGURATION_FILES.getMessage(),
                    ERROR_READING_CONFIGURATION_FILES.getCode(), e);
        }
