...
package com.wso2.identity.asgardeo.outbound.oidc.auth.service;

import com.wso2.identity.asgardeo.outbound.oidc.auth.service.exception.OutboundOIDCServiceException;
import com.wso2.identity.asgardeo.outbound.oidc.auth.service.interceptor.RequestInterceptor;
import com.wso2.identity.asgardeo.outbound.oidc.auth.service.models.ServerConfig;
import com.wso2.identity.asgardeo.outbound.oidc.auth.service.util.ConfigBuilder;
...
import static com.wso2.identity.asgardeo.outbound.oidc.auth.service.util.Constants.ErrorMessages.ERROR_GETTING_KEY_MANAGER_FILES;
import static com.wso2.identity.asgardeo.outbound.oidc.auth.service.util.Constants.ErrorMessages.ERROR_GETTING_TRUST_MANAGERS;
...
public class OutboundOIDCServer {
    ...
    private static KeyManager[] getKeyManagers(String path, String password, String type)
        ...
        try {
            ...
            throw new OutboundOIDCServiceException(ERROR_GETTING_KEY_MANAGER_FILES.getMessage(),
                    ERROR_GETTING_KEY_MANAGER_FILES.getCode(), e);
        }
    }
    ...
    private static TrustManager[] getTrustManagers(String path, String password, String type)
        ...
        try {
            ...
            throw new OutboundOIDCServiceException(ERROR_GETTING_TRUST_MANAGERS.getMessage(),
                    ERROR_GETTING_TRUST_MANAGERS.getCode(), e);
        }
    }
